...
class BookingNailsWidget extends StatefulWidget {
  const BookingNailsWidget({super.key});

  @override
  State<BookingNailsWidget> createState() => _BookingNailsWidgetState();
}

class _BookingNailsWidgetState extends State<BookingNailsWidget>
    with TickerProviderStateMixin {
  late BookingNailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BookingNailsModel());
